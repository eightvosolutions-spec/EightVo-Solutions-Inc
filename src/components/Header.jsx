...
export default function Header(){
  ...
  return <header className="ev-header" onKeyDown={closeOnEscape}><a className="ev-skip" href="#main-content">Skip to content</a><div className="ev-wrap ev-header-inner">
    <Link to="/" className="ev-brand" aria-label="EightVo Solutions home"><span className="ev-brand-symbol" aria-hidden="true">8</span><span>EightVo<span className="ev-brand-small">SOLUTIONS</span></span></Link>
