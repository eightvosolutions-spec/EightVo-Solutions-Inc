...
import { Capabilities, ProductFeature, CallToAction, Photo } from '../components/BrandContent'
export default function Home(){
  ...
  return <div className="ev-page">
    ...
    <div className="ev-hero-image"><Photo id="photo-1497366754035-f200968a6e72" alt="Bright collaborative workspace with natural light and greenery" eager/><div className="ev-image-shade"/><div className="ev-image-label"><span className="ev-live-dot"/> IDEAS INTO EVERYDAY IMPACT</div><div className="ev-image-caption">Technology feels better<br/>when people come first.</div><div className="ev-image-chip"><span aria-hidden="true">✦</span> AI + domain expertise</div></div></section>
    ...
    <ProductFeature/>
    <section className="ev-section ev-wrap ev-about"><Photo id="photo-1522071820081-009f0129c71c" alt="People collaborating around a table on a shared project"/><div><span className="ev-eyebrow">THE EIGHTVO APPROACH</span><h2>Great products start<br/>with understanding.</h2><p>Domain experts understand the real challenges. Our role is to turn that knowledge into useful digital experiences—with AI where it adds value and people at the heart of every decision.</p><p>For us, sustainable products are built for long-term usefulness: maintainable foundations, considered use of resources, and room to evolve as needs change.</p><Link className="ev-text-link" to="/about">Get to know EightVo <span aria-hidden="true">→</span></Link></div></section>
    <CallToAction/>
  </div>
}
