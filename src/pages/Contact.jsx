...
export default function Contact(){
  ...
  return <div className="ev-page"><section className="ev-wrap ev-page-intro ev-contact"><div><span className="ev-eyebrow">LET’S TALK</span><h1>Good things start<br/><em>with a conversation.</em></h1><p>Tell us about your idea, a challenge you’re working through, or your interest in MyCanJourney.</p><p>EightVo Solutions Inc.<br/>North York, Ontario, Canada</p><a className="ev-text-link" href="tel:+14379863162">+1 (437) 986-3162</a></div>
