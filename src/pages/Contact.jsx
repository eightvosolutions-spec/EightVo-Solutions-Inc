...
export default function Contact(){
  ...
  return <div className="ev-page"><PageBanner image="/images/expert-collaboration.webp" alt="Illustration of people discussing a product challenge together"/><section className="ev-wrap ev-page-intro ev-contact"><div><span className="ev-eyebrow">LET’S TALK</span><h1>Good things start<br/><em>with a conversation.</em></h1><p>Tell us about your idea, a challenge you’re working through, or your interest in MyCanJourney.</p><p>EightVo Solutions Inc.<br/>Unit 505, 350 Queens Quay W<br/>Toronto, ON M5V 3A7</p><a className="ev-text-link" href="tel:+14379863162">+1 (437) 986-3162</a></div>
